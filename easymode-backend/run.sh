...
if [ "$OFFLINE_MODE" -eq 1 ]; then
    ...
    echo "   🛒 AMAZON DEMO PAGES:"
    echo "      1. Lakmé Sun Expert SPF 50 [Strong Buy] 👉 http://localhost:8000/demo"
    echo "      2. Philips Digital Air Fryer [Strong Buy] 👉 http://localhost:8000/demo/amazon/B097RH8S8Q"
    echo "      3. Apple MacBook Air 13\" M3 [Strong Buy] 👉 http://localhost:8000/demo/amazon/B0CX23P5S5"
    echo "      4. Sony WH-1000XM5 Headphones [Mixed]    👉 http://localhost:8000/demo/amazon/B09XS7JWHH"
    echo "      5. boAt Bassheads 100 Earphones [Pass]    👉 http://localhost:8000/demo/amazon/B071Z8M4KX"
    echo ""
    echo "   🛍️ FLIPKART DEMO PAGES:"
    echo "      6. Apple iPhone 15 128GB [Strong Buy]    👉 http://localhost:8000/demo-flipkart"
    echo "      7. boAt Airdopes 141 TWS [Strong Buy]    👉 http://localhost:8000/demo/flipkart/ACCG5HFXMGBR8Z4H"
    echo "      8. Noise ColorFit Pulse 2 Max [Mixed]    👉 http://localhost:8000/demo/flipkart/SMWGG5T2C5QZYGBM"
    echo "      9. Nova NHT 1076 Trimmer [Pass]          👉 http://localhost:8000/demo/flipkart/TRMG6M5NZYHH7GKF"
    echo "--------------------------------------------------"
    echo "💡 Open any link above in Chrome with easymode extension."
